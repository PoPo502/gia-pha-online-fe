    ...
    return (
        <div className="landing-page-modern">
            ...
            <header className="modern-header">
                <div className="landing-container header-inner-modern">
                    ...
                    <div className="header-right-modern">
                        <div className="social-modern">
                            <a href="https://www.facebook.com/pham.uc.quann" target="_blank" rel="noreferrer">
                                {/* Facebook SVG icon */}
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="#1877F2" xmlns="http://www.w3.org/2000/svg" style={{ verticalAlign: 'middle' }}>
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                                {" "}Facebook
                            </a>
                            <a href="http://zalo.me/0965323336" target="_blank" rel="noreferrer">
                                {/* Zalo SVG icon */}
                                <svg width="22" height="22" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg" style={{ verticalAlign: 'middle' }}>
                                    <rect width="56" height="56" rx="28" fill="#0068FF" />
                        ...
                        {isLoggedIn ? (
                            <Link to="/dashboard" className="btn-modern-solid"><i className="bi bi-speedometer2"></i> Quản lý</Link>
                        ) : (
                            <Link to="/login" className="btn-modern-solid" onClick={handleLoginClick}><i className="bi bi-person-fill"></i> Đăng nhập</Link>
                        )}
                    </div>
                </div>
            ...
            <section id="top" className="hero-section-modern">
                <div className="landing-container hero-inner-modern">
                    <div className="hero-content-modern">
                        <h3 className="subtitle-modern">Phần mềm gia phả trực tuyến</h3>
                        <h1 className="title-modern">Gắn Kết Mọi Thế Hệ</h1>
                        <ul className="features-list-modern">
                            <li><i className="bi bi-flower1"></i> Tạo phả đồ chỉ trong vài bước</li>
                            <li><i className="bi bi-flower1"></i> Lưu trữ và quản lý gia phả trực tuyến</li>
                            <li><i className="bi bi-flower1"></i> Xây dựng website dòng họ</li>
                        </ul>
                        <div className="hero-buttons-modern">
                            {isLoggedIn ? (
                                <Link to="/dashboard" className="btn-modern-solid"><i className="bi bi-speedometer2"></i> Vào hệ thống quản lý</Link>
                            ) : (
                                <>
                                    <Link to="/login" className="btn-modern-solid"><i className="bi bi-person-fill"></i> Đăng nhập</Link>
                                    <a href="#contact" className="btn-modern-outline"><i className="bi bi-envelope"></i> Liên hệ đăng ký</a>
                                </>
                            )}
                        </div>
                    </div>
                    <div className="hero-image-modern">
                        <img src="/banner-intro-1.png" alt="Minh hoạ phần mềm" className="hero-mockup-img-modern"
